...
``` 
```{r}
all_airlines_summary %>% summarise(cor(average_seat_legroom_rating, average_overall_rating),
                                   cor(average_seat_recline_rating, average_overall_rating),
                                   cor(average_seat_width_rating, average_overall_rating),
                                   cor(average_aisle_space_rating, average_overall_rating))
```

```{r}
lm1 <- all_airlines_summary %>% ggplot(aes(x = average_seat_legroom_rating, y = average_overall_rating)) +
                                geom_point() +
                                geom_smooth(method = "lm", se=FALSE)

lm2 <- all_airlines_summary %>% ggplot(aes(x = average_seat_recline_rating, y = average_overall_rating)) +
                                geom_point() +
                                geom_smooth(method = "lm", se=FALSE)

lm3 <- all_airlines_summary %>% ggplot(aes(x = average_seat_width_rating, y = average_overall_rating)) +
                                geom_point() +
                                geom_smooth(method = "lm", se=FALSE)

lm4 <- all_airlines_summary %>% ggplot(aes(x = average_aisle_space_rating, y = average_overall_rating)) +
                                geom_point() +
                                geom_smooth(method = "lm", se=FALSE)

lm5 <- all_airlines_summary %>% ggplot(aes(x = average_viewing_tv_rating, y = average_overall_rating)) +
                                geom_point() +
                                geom_smooth(method = "lm", se=FALSE)
...
```{r}
overall_model3 <- lm(average_overall_rating ~ average_aisle_space_rating * average_seat_width_rating, data = all_airlines_summary)

summary(overall_model3)
tidy(overall_model3)
glance(overall_model3)
```


```{r}
overall_model1 <- lm(average_overall_rating ~ average_aisle_space_rating + average_seat_legroom_rating + average_seat_recline_rating + average_seat_width_rating + average_viewing_tv_rating, data = all_airlines_summary)

summary(overall_model1)
tidy(overall_model1)
glance(overall_model1)
```

```{r}
overall_model2 <- lm(formula = average_overall_rating ~ average_aisle_space_rating * average_seat_legroom_rating * average_seat_recline_rating * average_seat_width_rating * average_viewing_tv_rating, data = all_airlines_summary)

summary(overall_model2)
tidy(overall_model2)
glance(overall_model2)
```
