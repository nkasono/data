...
### Overall Seat Rating
```{r}
aircraft_model_ui <- c("737","747","757","767","777","787","A319","A320","A321","A330","A340","A380")

airline_name_ui <- c("AIR FRANCE","AMERICAN AIRLINES","BRITISH AIRWAYS","CATHAY PACIFIC AIRWAYS","EMIRATES","ETIHAD AIRWAYS","LUFTHANSA","QANTAS AIRWAYS","QATAR AIRWAYS","SINGAPORE AIRLINES","VIRGIN ATLANTIC AIRWAYS", "KLM ROYAL DUTCH AIRLINES")

seats_tidy %>% filter(airline_name %in% airline_name_ui) %>%
               ggplot(aes( x = airline_name, y = overall_rating, group = airline_name))+
               geom_boxplot() +
