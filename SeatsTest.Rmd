...
```{r ggplot bar chart}
by_airline %>% ggplot(aes(x = airline_name, y = no_of_reviews,colour = airline_name))+
               geom_bar(stat = "identity") +
               theme_minimal() +
               theme(axis.text.x=element_text(size=6,angle=45, hjust=1), axis.ticks.x=element_blank(), legend.position="none") +
               labs(title = "The 12 Most Frequently Rated Airlines", x = "AIRLINE", y = "Number of Reviews")
```
### Distribution of 'overall rating' variable for top 12 most frequently rated airlines
...
most_rated_airlines %>% ggplot(aes( x = airline_name, y = overall_rating, color = airline_name))+
                        ...
                        labs(title = "Overall Rating by Most Rated Airlines", subtitle = "0 = Not Recommended, 1 = Recommended",
                             x = "AIRLINE", y = "Overall Rating")
```
### Average Category Rating Distribution for the 12 Most Rated Airlines
```{r ggplot}
most_rated_airlines %>% ggplot(aes(mean_cat_rating)) +
                        ...
                        labs(title = "Average Category Rating Distribution for the 12 Most Rated Airlines",
                             x = "Average Category Rating", y = "Density of Average Category Rating")
...
### Distribution of the mean of the '5 Category Ratings' for the most frequently rated airlines
```{r}
most_rated_airlines %>% ggplot(aes( x = airline_name, y = mean_cat_rating, color = airline_name))+
                        ...
                        theme_minimal() +
                        theme(axis.text.x=element_blank(), axis.ticks.x=element_blank(), legend.text = element_text(size=6)) +
                        labs(title = "Average Category Rating by Most Frequently Rated Airlines", x = "AIRLINE", y = "Mean of the 5 Category Ratings")
```
